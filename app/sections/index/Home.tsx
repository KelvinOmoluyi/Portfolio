            ...
            <div className="hero-section-contents wrapper">
                <div className="contents-box">
                    ...
                    <div className="buttons-container">
                        ...
                        <a href="https://docs.google.com/document/d/1L6CNY4h-m7Tr1TV3JV17BGi30eZqUZ6W8HaDiQintak/edit?usp=sharing" target="_blank">
                        ...
                        <div className="social-media">
                            <div className="icon">
                                <Image width={34} height={34} src="https://img.icons8.com/fluency-systems-regular/100/3d32c2/globe--v1.png" alt="globe--v1"/>
                            </div>
                            <div className="social-media-handles">
                                <a href="https://x.com/KelvinOmoluyi?t=O8jwViwrl4a2foHgMcXxCg&s=09" target="_blank">  
                                    <div className="sm">
                                        <Image width={30} height={30} src="https://img.icons8.com/windows/100/3d32c2/twitterx.png" alt="twitterx"/>
                                    </div>
                                </a> 
                                <a href="https://www.linkedin.com/in/kelvin-omoluyi-6aa90031b?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BaFO6WMsyQs%2B0wrJYtd2IXQ%3D%3D" target="_blank">  
                                    <div className="sm">
                                        <Image width={30} height={30} src="https://img.icons8.com/windows/100/3d32c2/linkedin.png" alt="linkedin"/>
                                    </div>
                                </a>
                                <a href="https://wa.link/3ppx7r" target="_blank">  
                                    <div className="sm">
                                        <Image width={26} height={26} src="https://img.icons8.com/material-outlined/96/3d32c2/whatsapp--v1.png" alt="whatsapp--v1"/>
                                    </div>
                                </a>
                            </div>
                        </div>
